...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $updateStmt = $conn->prepare("UPDATE inventory
            ...
            WHERE id = ?");
        $updateStmt->execute([$name, $code, $price, $stock, $min, $id]);
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" name="item" class="form-control"
                    value="<?= htmlspecialchars($item['item']) ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="row g-3 mb-3">
                <div class="col-6">
                    ...
                    <input type="number" name="quantity_in_stock" class="form-control"
                        value="<?= $item['quantity_in_stock'] ?>" required>
                </div>
                <div class="col-6">
                    <label class="form-label">Minimum Stock Level</label>
                    <input type="number" name="min_stock_level" class="form-control"
                        value="<?= $item['min_stock_level'] ?>" required>
                </div>
            </div>
            ...
            <div class="row g-2 mt-2">
                ...
                <div class="col-12 col-sm-6">
                    <a href="invent_list_page.php" class="btn btn-back w-100">
