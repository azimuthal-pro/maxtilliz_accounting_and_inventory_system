...
$params = [];
if ($fromDate) { $query .= " AND purchase_date >= ?"; $params[] = $fromDate; }
if ($toDate)   { $query .= " AND purchase_date <= ?"; $params[] = $toDate . ' 23:59:59'; }
if ($supplier && $supplier !== 'All') { $query .= " AND supplier = ?"; $params[] = $supplier; }
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div><a href="../Dashboard/page.php" class="btn btn-secondary no-print">← Back to Dashboard</a></div>
        ...
        <form method="get" class="row g-3">
            ...
            <div class="col-12 col-md-3">
                ...
                <select name="supplier" class="form-select">
                    ...
                    <?php foreach ($conn->query("SELECT DISTINCT supplier FROM purchases WHERE supplier IS NOT NULL ORDER BY supplier ASC")->fetchAll() as $s): ?>
                        <option value="<?= htmlspecialchars($s['supplier']) ?>" <?= $supplier == $s['supplier'] ? 'selected' : '' ?>>
            ...
            <div class="col-12 col-md-3 d-flex align-items-end gap-2">
                <button type="submit" class="btn w-100" style="background-color:#262161;color:white;">Filter</button>
...
<div class="table-responsive">
    <table class="table table-bordered table-striped">
        <thead class="table-dark">
            <tr><th>#</th><th>Date</th><th>Supplier</th><th>Total Cost (GHS)</th></tr>
        </thead>
        <tbody>
            <?php if ($purchases): ?>
